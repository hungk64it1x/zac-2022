...
weights = [0.3, 0.3, 0.4, 0.25, 0.3, 0.15, 0.15, 0.15]
...
sizes = [224, 224, 224, 128, 128, 128, 128, 128]
...
names = ['convnext_large', 'convnext_large', 'convnext_large', 'convnext_xlarge', 'convnext_xlarge', 'convnext_xlarge', 'convnext_xlarge', 'convnext_xlarge']
print('Loading model ...')
...
for test_case in tqdm(test_cases):
    ...
    score = 0.3 * sum(outputs[:3]) + 0.7 * sum(outputs[3:])
